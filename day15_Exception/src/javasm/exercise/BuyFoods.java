...
//                        System.out.println(statueEnum.getMessage());
                        StatueEnum statueEnum = StatueEnum.MY_STATUE_ENUM_ADD_FOOD ;
...
enum StatueEnum {
    ...
    MY_STATUE_ENUM_NO_FOOD(1003, "没有这个商品哦！"),
    MY_STATUE_ENUM_NULL_FOOD(1004, "商品卖光了！下次早点来。"),
    MY_STATUE_ENUM_ADD_FOOD(1005, "\t咦！库存不足了。别着急！ 正在补货^-^......\n \t\t叮！补货成功！补货5件\n");
