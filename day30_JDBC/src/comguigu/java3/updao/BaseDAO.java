...
public abstract class BaseDAO<T> {
    ...
    private Class<T> operationClass = null ;

    {
        ...
        operationClass = (Class<T>) typeArguments[0];//泛型的第一个参数
    }
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                for (int i = 0; i < columnCount; i++) {
                    ...
                    final Field field = operationClass.getDeclaredField(columnLabel);
    ...
    public  List<T> getInstanceList(Connection connection,  String sql, Object... objects) {
        ...
        try {
            ...
            while (resultSet.next()) {
                final T t = operationClass.newInstance();
                final int columnCount = metaData.getColumnCount();
