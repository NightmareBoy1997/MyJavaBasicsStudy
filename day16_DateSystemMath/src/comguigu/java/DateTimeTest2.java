...
public class DateTimeTest2 {
    ...
    public void testCalendar(){
        ...
        //void set(int field,int newValue);
        //Calendar可变性
        calendar.set(Calendar.DAY_OF_MONTH,2);
        System.out.println(calendar.get(Calendar.DAY_OF_MONTH));

        // void add(int field,int duration);
        ...
        //获得这一天是这一周的第几天
        int days = calendar.get(Calendar.DAY_OF_WEEK); // 获取这一天是这周的第几天
        int years = calendar.get(Calendar.YEAR); // 获取年
        int days1 = calendar.get(Calendar.DAY_OF_YEAR); // 获取这一天是这一年的第几天
